...
/plugin install medusa-dev@medusaLa parte del hero quiero que tenga letras mas grandes y que sean animadas

en la parte de home quiero que este solo la seccion de los rectangulos animados. no quiero la lista de abajo porque es repetitivo. y para cada categoria ponle una foto de las que te pase que es camara, tripode, accesorios y lentes
```
